        ...
        <Box className={classes.description}>
          <Box component="div" className="header">
            <h2 className="headingSub">
              Streaming<strong className="dot">.</strong> Sharing
              <strong className="dot">.</strong> Content
              <strong className="dot">.</strong>
            </h2>
            <h2 className="headingMain">ALL IN ONE</h2>
            <h2 className="headingSubMain">
              <span className="textPrimary">Magnet Fishing </span>Source
            </h2>
          </Box>
          <p className="para">
            Magnet Fishing USA is the ultimate source for magnet fishing. We are
            the first social network dedicated 100 % to the sport. Magnet
            Fishing USA lets you interact with other magnet fishers and enjoy a
            heightened digital magnet fishing experience.
            <br />
          ...
          <Button
            className="cta"
            variant="contained"
            endIcon={<HiOutlineArrowNarrowRight size={"2rem"} />}
          >
            Learn More
          </Button>
        </Box>
