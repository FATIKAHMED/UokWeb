...
const SearchBar = ({ onOpen,onTagChange }) => {
    ...
    <>
      <div className={classes.searchContainer} >
        <Box className="wrapper">
          <span className='sortLabel'>SORT POSTS BY:</span>
          <SearchAutocompleteTag onTagChange={onTagChange}/>
        </Box>
        <Button variant='contained' size='large' color="primary" disableElevation className='postBtn' onClick={onOpen}>Post</Button>
      </div>
    </>
  )
}
